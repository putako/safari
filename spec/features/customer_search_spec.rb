...
feature "Customer Search" do
	...
	scenario "Search by Name" do
		...
		within "section.search-results" do
			#within reacts to changes in the DOM... had to change the index.html.erb to actually ng-if on results to keep this test from failing
			expect(page).to have_content("MUHFUGN RESULTS BIIIITCH")
